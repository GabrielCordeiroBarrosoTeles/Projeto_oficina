...
<body>
     <div class="d-flex" id="wrapper">
        ...
        <div id="sidebar-wrapper">
            <div class="sidebar-heading"><img src="logo.png"><span>Oficina</span></div>
        ...
        <div id="page-content-wrapper">
            ...
            <hr>
            <center><h2>
                    <img src="img/logo_baixinho.png" width="20%"><br>
                   Lista de Serviços</h2>
            </center>
            <center><form  action="pesquisa_os_com_placa.php" method="post">
                    Placa veículo:<br>
